...
//   /** ✅ NEW: Track last clicked subcategory */
...
//       // ✅ Relevant subcategories for this category
//       const relevantSubcategories = selectedSubcategories.filter((s) =>
//         s.startsWith(`${product.category}:`)
//       );

//       // ✅ Subcategory filtering
//       if (relevantSubcategories.length > 0) {
//         return relevantSubcategories.some(
...
//   /* ✅ SORTING: Priority subcategory products come first */
//   const sortedProducts = useMemo(() => {
//     if (!prioritySubcategory) return filteredProducts;

//     return [...filteredProducts].sort((a, b) => {
//       const [catId, subId] = prioritySubcategory.split(":");

//       const aMatch = a.category === catId && a.subcategory === subId;
//       const bMatch = b.category === catId && b.subcategory === subId;
